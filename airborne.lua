...
------------------------- Layer setup -------------------------
---------------------------------------------------------------
s0 = Layer("s0", 7, 8, "#7f8c8dff", "#7f8c8dff")
gs1 = Layer("gs1", 8, 9, "#2ecc71ff", "#7f8c8dff")
g0 = Layer("g0", 8, 9, "#16a085ff", "#c0392bff")
g0_0 = Layer("g0_0", 8, 9, "#16a085ff", "#c0392bff")
g1 = Layer("g1", 8, 9, "#16a085ff", "#c0392bff")
g1_0 = Layer("g1_0", 8, 9, "#2ecc71ff", "#c0392bff")
g2 = Layer("g2", 9, 10, "#11d116ff", "#c0392bff")
l0 = Layer("l0", 8, 9, "#3daee9ff", "#3daee9ff")
l1 = Layer("l1", 8, 9, "#3daee9ff", "#3daee9ff")
b0 = Layer("b0", 8, 9, "#5a1e1e", "#c0392bff")
